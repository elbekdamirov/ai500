...
const team = [
  {
    ...
    description:
      "Loyihalarni tadqiq qilish, foydalanuvchi muammolarini aniqlash va pitching bo'yicha mutaxassis. Muammoning real bozor qiymatini tushuntiradi va loyiha strategiyasini boshqaradi.",
  },
    {
  ...
  },
  {
    ...
    description:
      "Platformaning frontend interfeysi va foydalanuvchi tajribasi (UX) uchun mas'ul. React, Next.js va TailwindCSS yordamida tez va qulay interfeys yaratadi.",
  },
];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-gray-400">
            Muammoni chuqur tushungan, texnik bilim va mahalliy bozor
            tajribasiga ega jamoa.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {team.map((member, index) => (
            <div
              key={index}
              className="bg-gray-900 rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-800 hover:border-primary-500 group"
            >
              <div className="mb-6">
                <img
                  src={member.image}
              ...
              <p className="text-primary-500 text-sm font-medium mb-4 text-center">
                {member.role}
              </p>
