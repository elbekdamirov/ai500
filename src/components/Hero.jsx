      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-20 text-center">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed drop-shadow-md">
            AgroXizmat — bu fermerlar, texnika egalari va bank o‘rtasidagi
            ishonchli ko‘prik. Adolatli narx, tezkor xizmat va kafolatlangan
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <a
              href="#solution"
              className="px-8 py-4 rounded-full bg-primary-600 text-white font-bold text-lg hover:bg-primary-500 transition-all shadow-lg shadow-primary-500/30 transform hover:-translate-y-1 hover:scale-105 inline-block"
            >
              Xizmat Topish
            </a>
            <a
              href="#solution"
              className="px-8 py-4 rounded-full bg-white/10 text-white font-bold text-lg border border-white/20 hover:bg-white/20 backdrop-blur-sm transition-all transform hover:-translate-y-1 inline-block"
            >
              Batafsil Ma'lumot
            </a>
          </div>
